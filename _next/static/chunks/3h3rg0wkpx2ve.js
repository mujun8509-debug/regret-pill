(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,18566,(e,t,s)=>{t.exports=e.r(76562)},55770,e=>{"use strict";var t=e.i(47167);let s=`你是一名专业的决策分析系统。请对用户的输入进行结构化分析，提取关键信息并分类。
...
2. 保持客观中立，不做价值判断
3. 情绪强度基于文本表达的程度评估`,a=`你是一名路径分析系统。基于用户提供的后悔事件，生成三条分析路径。
...
2. 每条路径必须同时包含收益和代价
3. 隐藏线要有创意，不能是简单的折中
4. 所有表述使用不确定语气，避免绝对化`,r=`你是一名路径推演系统。基于用户选择的路径，进行时间轴推演分析。
...
5. 最终必须回到当下可执行的行动建议`,o=`你是一名分析总结系统。基于用户的后悔事件和选择路径，生成结构化分析报告。
...
`,{content:g,error:y}=await v(d,s,"analyze"),{data:h,error:p}=b(g,JSON.parse(f("analyze")));return h}async function _(e,t,s){let r=u(`${e} ${t} ${s}`);if(r.detected)throw Error(r.reason);let i=`
${m("后悔事件",e)}
${m("当时选择",t)}
${m("期望选择",s)}

请基于以上信息生成三条分析路径，用JSON格式返回结果。
`,{content:o,error:n}=await v(i,a,"choices"),{data:c,error:l}=b(o,JSON.parse(f("choices")));return c}async function N(e,t,s){let a=u(`${e} ${t} ${s}`);if(a.detected)throw Error(a.reason);let i=`
${m("后悔事件",e)}
${m("选择路径",t)}
${m("路径描述",s)}

请基于以上信息进行时间轴推演分析，用JSON格式返回结果。
`,{content:o}=await v(i,r,"simulate"),{data:n}=b(o,JSON.parse(f("simulate")));return n}async function j(e,t,s){let a=u(`${e} ${t}`);if(a.detected)throw Error(a.reason);let r=`
${m("后悔事件",e)}
${m("选择路径",t)}
分析风格：${s}

请基于以上信息生成结构化分析报告，用JSON格式返回结果。
`;if("emotional"===s){let t=function(e,t=2){return g.map(t=>{let s=t.tags.filter(t=>e.some(e=>t.includes(e)||e.includes(t))).length;return{quote:t,score:s}}).filter(e=>e.score>0).sort((e,t)=>t.score-e.score).slice(0,t).map(e=>e.quote)}(function(e){let t=new Set,s=e.toLowerCase();for(let[e,a]of Object.entries({表白:["感情","遗憾","错过","暗恋"],暗恋:["暗恋","遗憾","感情","错过"],分手:["离别","感情","遗憾","痛苦"],失恋:["离别","感情","遗憾","痛苦"],喜欢:["感情","遗憾","暗恋"],爱:["感情","遗憾","错过"],在一起:["感情","遗憾","错过"],错过:["遗憾","错过","如果"],遗憾:["遗憾","错过","如果"],后悔:["遗憾","悔恨","如果"],考研:["选择","成长","困境"],高考:["选择","成长","困境"],工作:["选择","现实","困境"],辞职:["选择","现实","勇气"],跳槽:["选择","现实","勇气"],失业:["困境","无力","迷茫"],父母:["家庭","遗憾","时间"],家人:["家庭","遗憾","时间"],离婚:["离别","感情","痛苦"],结婚:["选择","感情","现实"],钱:["现实","选择","困境"],投资:["选择","现实","遗憾"],买房:["选择","现实","压力"],朋友:["人际","遗憾","离别"],吵架:["人际","情绪","遗憾"],误会:["人际","遗憾","错过"],自卑:["自我","无力","成长"],害怕:["无力","恐惧","勇气"],焦虑:["焦虑","压力","迷茫"],迷茫:["迷茫","困惑","选择"],孤独:["孤独","漂泊","人生"],压力:["压力","焦虑","困境"],痛苦:["痛苦","伤害","疗愈"],难过:["痛苦","伤感","情绪"],伤心:["痛苦","伤感","情绪"],累:["疲惫","压力","困境"],放弃:["放弃","遗憾","选择"],坚持:["韧性","成长","坚强"],勇敢:["勇气","成长","自我"],梦想:["梦想","现实","选择"],现实:["现实","妥协","接受"],时间:["时间","遗憾","成长"],过去:["过去","回忆","放下"],回忆:["回忆","过去","怀念"],如果:["如果","遗憾","假设"],当初:["如果","遗憾","假设"],曾经:["回忆","过去","曾经拥有"],现在:["当下","接受","现实"],未来:["希望","向往","新生"],成长:["成长","蜕变","经历"],改变:["改变","成长","选择"],接受:["接受","释然","放下"],放下:["放下","释然","接受"],释怀:["释然","放下","接受"],原谅:["释然","放下","疗愈"],理解:["理解","释然","成长"],明白:["清醒","成长","理解"],懂得:["理解","成长","清醒"]}))s.includes(e)&&a.forEach(e=>t.add(e));return 0===t.size?["遗憾","成长","选择"]:Array.from(t)}(e),3);if(t.length>0){let e=t.map(e=>{let t=e.source?`（${e.source}）`:"";return`「${e.text}」${t}`}).join("\n");r+=`
【动态匹配引用】根据用户输入内容，以下引用与情境高度相关，优先选择使用：
${e}

注意：以上仅为推荐引用，AI 可根据实际分析需要选择使用或不使用，也可从已有知识库中选择更合适的引用。`}}let{content:i}=await v(r,o,"feedback"),{data:n}=b(i,JSON.parse(f("feedback")));return n}async function w(e,t,s,a){let r=u(`${e} ${t} ${s} ${a}`);if(r.detected)throw Error(r.reason);let o=`
${m("后悔事件",e)}
${m("当时选择",t)}
${m("期望选择",s)}
${m("选择路径",a)}
...
`,{content:n}=await v(o,i,"psychological"),{data:c}=b(n,JSON.parse(f("psychological")));return c}e.s(["clientAnalyze",0,k,"clientChoices",0,_,"clientFeedback",0,j,"clientPsychological",0,w,"clientSimulate",0,N],55770)},77391,e=>{"use strict";var t=e.i(43476),s=e.i(71645),a=e.i(18566),r=e.i(55770);e.s(["default",0,function(){let e=(0,a.useRouter)(),[i,o]=(0,s.useState)(!1),[n,c]=(0,s.useState)(""),[l,d]=(0,s.useState)({regretText:"",originalChoice:"",desiredChoice:"",analysisStyle:"rational"}),u=async t=>{t.preventDefault(),o(!0),c("");try{localStorage.setItem("regret_data",JSON.stringify(l));let t=await (0,r.clientAnalyze)(l.regretText,l.originalChoice,l.desiredChoice,l.analysisStyle);if("high"===t.risk_level){localStorage.setItem("regret_high_risk","true"),e.push("/result");return}let s=await (0,r.clientChoices)(l.regretText,l.originalChoice,l.desiredChoice);localStorage.setItem("regret_analysis",JSON.stringify(t)),localStorage.setItem("regret_choices",JSON.stringify(s)),e.push("/choices")}catch(e){c(e instanceof Error?e.message:"提交失败，请重试")}finally{o(!1)}};return(0,t.jsxs)("main",{id:"main-content",className:"dark-container min-h-screen flex flex-col",children:[(0,t.jsx)("div",{className:"w-full dark-nav",children:(0,t.jsxs)("div",{className:"max-w-2xl mx-auto px-4 py-4 flex items-center justify-between",children:[(0,t.jsxs)("div",{className:"flex items-center gap-3",children:[(0,t.jsx)("button",{onClick:()=>e.push("/"),style:{color:"var(--dark-text-muted)"},className:"hover:text-white transition-colors",children:(0,t.jsx)("svg",{className:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,t.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M10 19l-7-7m0 0l7-7m-7 7h18"})})}),(0,t.jsxs)("div",{children:[(0,t.jsx)("h1",{style:{fontFamily:"var(--font-display)",fontSize:"0.9375rem",fontWeight:600,color:"var(--dark-text-primary)"},children:"输入分析内容"}),(0,t.jsx)("p",{style:{fontSize:"0.75rem",color:"var(--dark-text-muted)",fontFamily:"var(--font-mono)",marginTop:"0.25rem"},children:"步骤 1/3"})]})]}),(0,t.jsxs)("div",{className:"step-indicator",children:[(0,t.jsx)("div",{className:"step-dot active"}),(0,t.jsx)("div",{className:"step-dot"}),(0,t.jsx)("div",{className:"step-dot"})]})]})}),(0,t.jsx)("div",{className:"flex-1 px-4 py-10",children:(0,t.jsx)("div",{className:"max-w-2xl mx-auto",children:(0,t.jsxs)("form",{onSubmit:u,className:"space-y-6",children:[(0,t.jsxs)("div",{className:"dark-surface p-6",children:[(0,t.jsxs)("div",{className:"flex items-center gap-3 mb-5",children:[(0,t.jsx)("span",{className:"w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold",style:{background:"var(--dark-accent-muted)",color:"var(--dark-accent)",fontFamily:"var(--font-mono)"},children:"1"}),(0,t.jsx)("label",{className:"dark-section-title",children:"后悔事件"})]}),(0,t.jsx)("textarea",{required:!0,value:l.regretText,onChange:e=>d({...l,regretText:e.target.value}),className:"dark-input",rows:4,placeholder:"描述一件让你后悔的事，例如：大三时放弃了考研机会，选择直接就业..."})]}),(0,t.jsxs)("div",{className:"dark-surface p-6",children:[(0,t.jsxs)("div",{className:"flex items-center gap-3 mb-5",children:[(0,t.jsx)("span",{className:"w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold",style:{background:"var(--dark-accent-muted)",color:"var(--dark-accent)",fontFamily:"var(--font-mono)"},children:"2"}),(0,t.jsx)("label",{className:"dark-section-title",children:"当时的选择"})]}),(0,t.jsx)("textarea",{required:!0,value:l.originalChoice,onChange:e=>d({...l,originalChoice:e.target.value}),className:"dark-input",rows:3,placeholder:"你当时实际做了什么选择？"})]}),(0,t.jsxs)("div",{className:"dark-surface p-6",children:[(0,t.jsxs)("div",{className:"flex items-center gap-3 mb-5",children:[(0,t.jsx)("span",{className:"w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold",style:{background:"var(--dark-accent-muted)",color:"var(--dark-accent)",fontFamily:"var(--font-mono)"},children:"3"}),(0,t.jsx)("label",{className:"dark-section-title",children:"期望的选择"})]}),(0,t.jsx)("textarea",{required:!0,value:l.desiredChoice,onChange:e=>d({...l,desiredChoice:e.target.value}),className:"dark-input",rows:3,placeholder:"如果重来，你希望怎么选择？"})]}),(0,t.jsxs)("div",{className:"dark-surface p-6",children:[(0,t.jsxs)("div",{className:"flex items-center gap-3 mb-5",children:[(0,t.jsx)("span",{className:"w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold",style:{background:"var(--dark-accent-muted)",color:"var(--dark-accent)",fontFamily:"var(--font-mono)"},children:"4"}),(0,t.jsx)("label",{className:"dark-section-title",children:"分析风格"})]}),(0,t.jsx)("div",{className:"choice-grid",children:[{value:"rational",label:"理性拆解",desc:"逻辑分析，利弊权衡"},{value:"emotional",label:"情感梳理",desc:"情绪识别，感受整理"},{value:"realistic",label:"现实对照",desc:"实际情况，可行性分析"}].map(e=>(0,t.jsx)("button",{type:"button",onClick:()=>d({...l,analysisStyle:e.value}),className:`dark-option-card ${l.analysisStyle===e.value?"selected":""}`,"aria-pressed":l.analysisStyle===e.value,role:"radio","aria-checked":l.analysisStyle===e.value,children:(0,t.jsxs)("div",{className:"flex flex-col items-center gap-2",children:[(0,t.jsx)("p",{style:{fontFamily:"var(--font-display)",fontSize:"0.9375rem",fontWeight:600,color:l.analysisStyle===e.value?"var(--dark-accent)":"var(--dark-text-primary)"},children:e.label}),(0,t.jsx)("p",{style:{fontSize:"0.75rem",color:"var(--dark-text-muted)"},children:e.desc})]})},e.value))})]}),n&&(0,t.jsx)("div",{className:"p-4 rounded-lg",style:{background:"rgba(220, 38, 38, 0.1)",border:"1px solid rgba(220, 38, 38, 0.2)"},children:(0,t.jsx)("p",{style:{fontSize:"0.875rem",color:"#EF4444"},children:n})}),(0,t.jsxs)("div",{className:"flex flex-col items-center gap-3 pt-2",children:[(0,t.jsx)("button",{type:"submit",disabled:i,className:"dark-btn-primary w-full max-w-xs",children:i?(0,t.jsxs)("span",{className:"flex items-center gap-2",children:[(0,t.jsx)("span",{className:"loading-ring",style:{width:"18px",height:"18px",borderWidth:"2px"}}),"分析中..."]}):(0,t.jsxs)("span",{className:"flex items-center gap-2",children:[(0,t.jsx)("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,t.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"})}),"生成分析报告"]})}),(0,t.jsx)("p",{style:{fontSize:"0.8125rem",color:"var(--dark-text-muted)",fontFamily:"var(--font-mono)"},children:"分析过程约需 10-20 秒"})]})]})})})]})}])}]);